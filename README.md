...
| 日期 | 摘要 |
|------|------|
| [2026-07-08](changelog/2026-07-08.md) | **Durable Short-Term Memory（持久化短期记忆）**：PostgreSQL LangGraph 持久化、稳定 Thread ID（无日期）、Turn-scoped reset envelope、Advisory lock 跨 Worker 序列化、Bounded topic restore、标准/流式路径统一 prepare_online_turn、钉钉重复投递静默、Reset 状态机、24 场景评估门控。详见 [`docs/runbooks/short-term-memory.md`](docs/runbooks/short-term-memory.md)。 |
